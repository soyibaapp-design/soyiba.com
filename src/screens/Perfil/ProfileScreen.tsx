    ...
    <section className="space-y-4 pb-4">
      ...
      <div className="rounded-[16px] border border-[#D8E5F7] bg-white px-4 py-3 text-center shadow-[0_14px_32px_rgba(15,23,42,0.06)]">
        ...
        <div className="mt-2 flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
          <LegalDocumentButton documentId="data-policy" className="inline-flex items-center gap-1 text-[11px] font-black text-[#145CFF] underline-offset-4 hover:underline">
            <FileText size={13} />
            Política de Tratamiento de Datos
          </LegalDocumentButton>
          <LegalDocumentButton documentId="terms" className="inline-flex items-center gap-1 text-[11px] font-black text-[#145CFF] underline-offset-4 hover:underline">
            <FileText size={13} />
            Términos de Uso
          </LegalDocumentButton>
        </div>
